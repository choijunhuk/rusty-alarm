...
data class AlarmEntity(
    ...
    fun toAlarm(): Alarm = Alarm(
        ...
        routineItems = if (routineItems.isBlank()) emptyList()
                       else routineItems.split("|").filter { it.isNotBlank() },
    ...
    companion object {
        fun fromAlarm(alarm: Alarm): AlarmEntity = AlarmEntity(
            ...
            routineItems = alarm.routineItems.joinToString("|"),
            youtubeUrl = alarm.youtubeUrl,
            alarmVolumePercent = alarm.alarmVolumePercent,
